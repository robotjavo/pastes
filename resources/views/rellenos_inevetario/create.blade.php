...
<div class="section-content">
    ...
    <div class="container">
        ...
        <form action="{{ route('rellenos_inevetario.store') }}" method="POST">
            @csrf

            <div class="form-group">
                <label for="nombre">relleno:</label>
        ...
        <div class="flex items-center justify-between mt-4">
            <a class="text-sm font-semibold underline border-2 border-transparent rounded dark:text-slate-300 text-slate-600 focus:border-slate-500 focus:outline-none" href="{{ route('rellenos_inevetario.index') }}">cancelar</a>
    </div>
@endsection
