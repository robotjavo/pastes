...
<div class="section-content">
    ...
    <div class="container">
        <h1 id="title_name">Inventario de masas</h1>


<a href="{{ route('masas_inevetario.create') }}" class="success">Agregar entrada</a>
        ...
        <table class="table mt-3">
            ...
            <tbody>
                @foreach ($masasInventario as $inventario)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('masas_inevetario.edit', $inventario->id) }}" class="btn btn-warning">agregar</a>
                            <form action="{{ route('masas_inevetario.destroy', $inventario->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
